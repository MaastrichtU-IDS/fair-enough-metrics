...
class MetricTest(FairTest):
    metric_path = 'i1-metadata-knowledge-representation-structured'
    applies_to_principle = 'I1'
    title = 'Metadata uses a formal structured knowledge representation language'
...
This particular test takes a broad view of what defines a 'knowledge representation language'; in this evaluation, anything that can be represented as structured data will be accepted"""
    ...
    test_test={
        ...
        'https://w3id.org/fair-enough/metrics/tests/a1-access-protocol': 1,
        'http://example.com': 0,
    }
