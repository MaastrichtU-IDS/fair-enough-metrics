...
def main():
    ...
    for eval in eval_list:
        ...
        r = requests.post(f"{api_fair_enough}",
            json={ 
                'subject': eval['subject'],
                'collection': 'fair-enough-metrics',
            },
    ...
    # TODO: output CSV? Or directly retrieve metadata from the API?
    # subject, collection, score, score_percent, metrics_a1, metrics_a2 (0/1) , etc...
